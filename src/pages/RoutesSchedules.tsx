...
const schedule = [
  ...
  { time: "6:30 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "7:00 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "7:30 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "8:00 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "8:30 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "9:00 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
  { time: "9:30 AM", routeA: "✓", routeB: "✓", routeC: "✓" },
];
...
const fares = [
  {
    ...
    category: "Adult",
    price: "Rs. 30",
    description: "Standard fare for all adults",
  },
  {
    icon: GraduationCap,
    category: "Student",
  ...
  },
  {
    ...
    category: "Senior/PWD",
    price: "Rs. 15",
    description: "Senior citizens & persons with disabilities",
  },
  {
    icon: Wallet,
